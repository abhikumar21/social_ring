     ...
     <div className="profile_page">
      <div className='profile_info'>
        <div className="pr_dp flex align-middle justify-center" >
          ...
          <img className="pr_dpro relaive h-32 w-32 mt-10 rounded-full" onClick={()=>setShow(!show)} src={profileUser.profilePicture ? process.env.REACT_APP_PUBLIC_FOLDER + profileUser.profilePicture : process.env.REACT_APP_PUBLIC_FOLDER + "defaultProfile.jpg"}></img>
        ...
        <div className="pr_info py-2">
          ...
          <div className='pr1_info flexed mt-4 mb-12'>
            ...
            {profileUserId!==user._id ? <>
                        ...
                        <Link to={`/chat`} className='pr_info2 bg-white text-black'>Message</Link>
                        </>
                        : ""
          }
