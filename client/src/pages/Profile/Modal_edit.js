...
const Modal_edit = ({profileUserId, data, show}) => {
  ...
  return (
    <>
    { (profileUserId===data._id) ? <Button onClick={handleOpen} className='edit_btn' ><a className='text-blue-400'>Edit</a></Button> : '' }
      ...
      >
        <Box sx={style} className="modal_box">
          <div className="edit_profile w-full">
           ...
           {image? 
           <>
            <div className="pro-image relaive mt-0 w-[120px] h-[120px] rounded-full flex justify-center items-center overflow-hidden">
              <img className="pr_dpro relaive w-full h-full object-cover" src={URL.createObjectURL(image)} alt="image"></img>
            </div>
           ...
           <div className="edit_info w-full flex flex-col">
            ...
            <span className="w-full py-0">
             ...
             <botton className="mt-2 bg-blue-600 text-white w-28 h-12 flex justify-center rounded-lg align-middle cursor-pointer" onClick={handleSubmit} >Submit</botton>
           </div>
