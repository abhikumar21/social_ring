  ...
  return (
    <>
     <div className="followers relative rounded-lg">
        ...
        <Link to = {`/profile/${followUser._id}`} className='name'>
         ...
         {followed ? <button onClick={handleUnfollow}>Unfollow</button> : <button className='text-cyan-200' onClick={handleFollow}>Follow</button>}
