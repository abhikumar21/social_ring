    ...
    <div className='sidebar flex flex-col z-50'>
     ...
     <div className='cardbg h-96 w-full mt-12'>
      <div className='relative h-1/2 bg-transparent text-black flex justify-center align-middle'>
        <h2 className="relative font-bold text-2xl mt-2">{user.firstname}</h2>
        <div className="pro-image absolute mt-14 w-[120px] h-[120px] rounded-full flex justify-center items-center overflow-hidden">
          <img className="pr_dpro relaive w-full h-full object-cover" src={user.profilePicture ? serverPublic + user.profilePicture : serverPublic + "defaultProfile.jpg"} alt="image"></img>
        </div>
      </div>
