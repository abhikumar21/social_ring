...
import { deleteImage } from '../action/uploadAction'
...
const handleDeletePost = () => {
  ...
  return (
    ...
    <div className='post px-2 py-4 mb-10 bg-slate-400 rounded-lg'>
      ...
      <Menu.Items className="bg-white absolute flex flex-col px-2 py-2 rounded-md right-6 top-8">
        <Menu.Item>
          {({ active }) => (
            <a
              className={`${active && 'bg-blue-500'} px-1 py-1 cursor-pointer`}
